...
wget -nv -O /tmp/omeka-2.6.zip https://github.com/omeka/Omeka/releases/download/v2.6/omeka-2.6.zip
unzip -q /tmp/omeka-2.6.zip -d /tmp
mv -v /tmp/omeka-2.6 $OMEKA_CORE_DIR
